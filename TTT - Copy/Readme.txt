...
I thought I could add a function that tracks the score. 

I practiced with creating the values used as arrays, vectors or as a string. I thiught that a vector would be a bigger challenge than string, so I went with it. 
